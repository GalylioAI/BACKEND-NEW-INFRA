...
import type { ShopPrice } from "../../lib/demo-data/types";
import {
  formatPrice,
  normalizeShopName,
  shopLogo,
...
const T = {
  bg: "#f5f3ff",
  bgImage:
    "radial-gradient(circle at 8% 10%, rgba(91,33,182,0.12) 0%, rgba(91,33,182,0.04) 36%, transparent 60%), radial-gradient(circle at 92% 14%, rgba(124,58,237,0.12) 0%, rgba(124,58,237,0.04) 32%, transparent 58%), radial-gradient(circle at 50% 95%, rgba(167,139,250,0.08) 0%, transparent 50%), linear-gradient(180deg, #f9f8ff 0%, #ede9fe 100%)",
  surface: "#ffffff",
  ...
  imgGlow:
    "radial-gradient(circle at 50% 40%, rgba(91,33,182,0.07), transparent 65%)",
  purple: "#7C3AED",
  purpleDark: "#5B21B6",
  ...
  blobA:
    "radial-gradient(ellipse at 50% 0%, rgba(167,139,250,0.30) 0%, rgba(167,139,250,0.12) 38%, transparent 72%)",
  blobB:
    "radial-gradient(circle, rgba(124,58,237,0.22) 0%, rgba(124,58,237,0.08) 45%, transparent 72%)",
  blobC:
    "radial-gradient(circle, rgba(91,33,182,0.16) 0%, rgba(91,33,182,0.05) 42%, transparent 74%)",
};
        ...
        >
          ...
          <span
            style={{
              fontSize: 14,
              fontWeight: 800,
              color: isBest ? T.purpleDark : T.text,
            }}
          >
      ...
      >
        <div
          style={{
            ...
            background: T.blobA,
            filter: "blur(8px)",
            animation: "pdAmbientA 20s ease-in-out infinite",
          }}
        />
        <div
          style={{
            ...
            background: T.blobB,
            filter: "blur(10px)",
            animation: "pdAmbientB 24s ease-in-out infinite",
          }}
        />
        <div
          style={{
            ...
            background: T.blobC,
            filter: "blur(12px)",
            animation: "pdAmbientA 28s ease-in-out infinite reverse",
          }}
        />
      </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            {stores.length > 0 && (
              <p
                style={{ margin: "4px 0 0", fontSize: 11, color: T.textMuted }}
              >
            ...
            <div
              style={{ height: 1, background: T.divider, margin: "12px 0 0" }}
            />
            <div
              style={{
                marginTop: 12,
                ...
                >
                  ...
                  <p
                    style={{
                      ...
                      fontSize: 14,
                      fontWeight: 800,
                      color: oos ? T.badgeOos : accent ? T.purpleDark : T.text,
                    }}
                  >
                    {value}
                  </p>
