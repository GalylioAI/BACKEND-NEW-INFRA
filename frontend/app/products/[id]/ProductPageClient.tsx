...
const D = {
  bg: "#0f1421",
  bgImage:
    "radial-gradient(circle at 12% 10%, rgba(59,222,185,0.05) 0%, rgba(59,222,185,0.012) 36%, transparent 62%), radial-gradient(circle at 86% 16%, rgba(86,180,233,0.04) 0%, rgba(86,180,233,0.01) 34%, transparent 60%), linear-gradient(180deg, #0f1421 0%, #0a0f1a 100%)",
  surface: "#171f31",
  ...
  imgGlow:
    "radial-gradient(circle at 50% 40%, rgba(59,222,185,0.05), transparent 65%)",
  teal: "#3BDEB9",
  ...
  blobA:
    "radial-gradient(ellipse at 50% 0%, rgba(147,197,253,0.14) 0%, rgba(147,197,253,0.06) 35%, transparent 72%)",
  blobB:
    "radial-gradient(circle, rgba(167,139,250,0.12) 0%, rgba(167,139,250,0.04) 45%, transparent 72%)",
  blobC:
    "radial-gradient(circle, rgba(148,163,184,0.10) 0%, rgba(148,163,184,0.03) 42%, transparent 74%)",
};
        ...
        >
          ...
          <span
            style={{
              fontSize: 14,
              fontWeight: 800,
              color: isBest ? D.teal : D.textSoft,
            }}
          >
      ...
      >
        <div
          style={{
            ...
            background: D.blobA,
            filter: "blur(10px)",
            animation: "pdAmbientA 22s ease-in-out infinite",
          }}
        />
        <div
          style={{
            ...
            background: D.blobB,
            filter: "blur(12px)",
            animation: "pdAmbientB 26s ease-in-out infinite",
          }}
        />
        <div
          style={{
            ...
            background: D.blobC,
            filter: "blur(14px)",
            animation: "pdAmbientA 30s ease-in-out infinite reverse",
          }}
        />
        <div
          style={{
            ...
            inset: 0,
            background:
              "radial-gradient(circle at 50% 20%, rgba(255,255,255,0.05), transparent 58%)",
            animation: "pdAmbientPulse 12s ease-in-out infinite",
          }}
        />
      </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            <a
              href={source === "para" ? "/parapharmacie" : "/products"}
              style={{
                color: "#ffffff",
                textDecoration: "none",
                fontWeight: 600,
        ...
        >
            ...
            >
              ...
              >
                ...
                <div
                  style={{
                    ...
                    top: 16,
                    right: 16,
                    background: product.inStock ? D.badge : D.badgeOos,
                    color: "#fff",
                    fontSize: 10,
                    fontWeight: 800,
                    borderRadius: 6,
              ...
              >
                <span style={{ fontSize: 11, color: D.textMuted }}>
                  Réf:{" "}
                  <span style={{ color: D.textSoft, fontWeight: 600 }}>
          ...
          >
            ...
            {stores.length > 0 && (
              <p
                style={{ margin: "4px 0 0", fontSize: 11, color: D.textMuted }}
              >
                Prix le plus bas chez{" "}
                <span style={{ color: D.teal, fontWeight: 700 }}>
                  {normalizeShopName(stores[0].shop)}
                </span>
              </p>
            )}
            <div
              style={{ height: 1, background: D.divider, margin: "12px 0 0" }}
            />
            <div
              style={{
                marginTop: 12,
              ...
              {[
                {
                  ...
                  value: `${availableShopsCount}/${totalShopsCount}`,
                },
                {
                  label: "Historique prix",
                  value: chartSeries.length > 0 ? "12 mois" : "N/A",
                },
                {
                  label: "Économie max",
                  value: bestGap ? formatPrice(bestGap) : "—",
                  accent: true,
                },
                {
                  label: "Statut global",
                  value: product.inStock ? "Disponible" : "Rupture",
                  oos: !product.inStock,
                },
                ...
                >
                  ...
                  <p
                    style={{
                      ...
                      fontSize: 14,
                      fontWeight: 800,
                      color: oos ? D.badgeOos : accent ? "#ffffff" : D.text,
                    }}
                  >
                    {value}
                  </p>
            ...
            {specs.map((spec, i) => (
              <div
                ...
                style={{
                  ...
                  padding: "12px 16px",
                  borderRadius: 10,
                  background: i % 2 === 0 ? D.specEvenBg : "transparent",
                  border: `1px solid ${D.border}`,
                }}
              >
                <span
                  style={{ fontSize: 13, color: D.textMuted, flexShrink: 0 }}
                >
                  {spec.label}
                </span>
                <span
...
export default function ProductPageClient(props: ProductPageClientProps) {
  ...
  return isLight ? (
    <ProductPageLight {...props} />
  ) : (
    <ProductPageDark {...props} />
  );
}
