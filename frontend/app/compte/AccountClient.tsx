  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div
          className="acct-row-value"
          style={{
            fontSize: 15,
            fontWeight: 600,
            color: empty ? "rgba(255,255,255,0.28)" : "#fff",
...
function QuickAction({
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div
          className="acct-action-label"
          style={{ fontSize: 14, fontWeight: 700, color: "#fff" }}
        >
          {label}
        </div>
        <div
          className="acct-action-sub"
          style={{
            fontSize: 12,
          ...
          <div className="acct-grid">
            ...
            <div className="acct-card acct-card-left">
              ...
              <InfoRow
                icon={
                  <svg
                    ...
                    strokeLinejoin="round"
                  >
                    <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81 19.79 19.79 0 0 0 .06 2.18 2 2 0 012 0h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.91 7.91a16 16 0 006.18 6.18l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z" />
                  </svg>
                }
                label="Téléphone"
              ...
              <InfoRow
                ...
                value={
                  user?.gouvernorat_id
                    ? `Gouvernorat #${user.gouvernorat_id}`
                    : "Non renseigné"
                }
              />
              ...
              <div className="acct-card">
                ...
                >
                  ...
                  <QuickAction
                    ...
                    sub="Renforcer la sécurité du compte"
                  />
                  <QuickAction
                    href="/compte/alertes"
                    icon={
                    ...
                    sub="Gérer les alertes et offres"
                  />
                </div>
              </div>
              ...
              <div className="acct-card">
                ...
                >
                  ...
                  <QuickAction
                    ...
                    label="Historique des comparaisons"
                    sub="Voir mes recherches récentes"
                  />
                </div>
              </div>
            </div>
