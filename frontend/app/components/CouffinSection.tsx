      ...
      <div className="home-box wow fadeInUp" data-wow-delay={card.delay}>
        <div className="innerbox">
          ...
          <div className="thumb">
            ...
            >
              ...
              <PrixBadge
                prix={card.prix}
                diff={card.diff}
                cheapest={card.cheapest}
              />
            </a>
            <a
              className="tf-btn-3 light_skew_hover demo-full-link"
              href={card.href}
              target="_blank"
            >
              Voir les prix
          ...
          <div className="content">
            <a href={card.href} target="_blank" className="title-box">
              {card.name}
            </a>
            {card.tags && card.tags.length > 0 && (
              <div className="tags">
                {card.tags.map((tag) => (
                  <div
                    key={tag}
                    className={`tag-item tag-${tag.toLowerCase()}`}
                  >
                    {tag}
                  </div>
                ))}
