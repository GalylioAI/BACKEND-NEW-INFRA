const sparkleIcon = (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <defs>
      <linearGradient id="paint0_faq" x1="15.5997" y1="13.2722" x2="10.1035" y2="10.7515" gradientUnits="userSpaceOnUse">
        <stop stopColor="#3BDEB9" /><stop offset="0.5" stopColor="#77E590" /><stop offset="1" stopColor="#CCFF9B" />
      </linearGradient>
      <linearGradient id="paint1_faq" x1="11.0396" y1="13.3199" x2="-1.78273" y2="7.43927" gradientUnits="userSpaceOnUse">
        <stop stopColor="#3BDEB9" /><stop offset="0.5" stopColor="#77E590" /><stop offset="1" stopColor="#CCFF9B" />
      </linearGradient>
      <linearGradient id="paint2_faq" x1="13.3198" y1="5.03906" x2="10.6038" y2="3.79314" gradientUnits="userSpaceOnUse">
        <stop stopColor="#3BDEB9" /><stop offset="0.5" stopColor="#77E590" /><stop offset="1" stopColor="#CCFF9B" />
      </linearGradient>
    </defs>
  </svg>
    ...
    <section className="section-faqs">
      <style>{`
        [data-theme="light"] .section-faqs {
          background: linear-gradient(180deg, #f4f6f3 0%, #edf1ec 100%) !important;
        }
        [data-theme="light"] .section-faqs > .img-item {
          opacity: 0.24 !important;
          filter: hue-rotate(230deg) saturate(0.82) brightness(1.08);
        }
        [data-theme="light"] .section-faqs .sub-title.box-tag {
          background: #ffffff !important;
          border: 1px solid rgba(15,23,42,0.18) !important;
          box-shadow: 0 8px 18px rgba(15,23,42,0.1) !important;
        }
        [data-theme="light"] .section-faqs .sub-title.box-tag .text-gradient.style-2 {
          background: none !important;
          color: #111827 !important;
          -webkit-text-fill-color: #111827 !important;
          font-weight: 800 !important;
        }
        [data-theme="light"] .section-faqs .sub-title.box-tag .eff {
          background: rgba(255,255,255,0.9) !important;
        }
        [data-theme="light"] .section-faqs .sub-title.box-tag svg path {
          fill: #111827 !important;
        }
        [data-theme="light"] .section-faqs .heading,
        [data-theme="light"] .section-faqs .heading .item-text,
        [data-theme="light"] .section-faqs .heading .item-text i {
          color: #0f172a !important;
          -webkit-text-fill-color: #0f172a !important;
          text-shadow: none !important;
        }
        [data-theme="light"] .section-faqs .heading-section > p {
          color: rgba(15,23,42,0.72) !important;
          font-weight: 600 !important;
        }
        [data-theme="light"] .section-faqs .accordion-item {
          background: linear-gradient(170deg, rgba(255,255,255,0.98), rgba(248,250,252,0.95)) !important;
          border: 1.5px solid rgba(15,23,42,0.14) !important;
          box-shadow: 0 12px 28px rgba(15,23,42,0.1) !important;
        }
        [data-theme="light"] .section-faqs .accordion-item .accordion-title .text {
          color: #111827 !important;
          font-size: 17px !important;
          font-weight: 800 !important;
        }
        [data-theme="light"] .section-faqs .accordion-item .accordion-faqs-content p {
          color: rgba(15,23,42,0.7) !important;
          font-size: 14px !important;
          font-weight: 600 !important;
        }
        [data-theme="light"] .section-faqs .accordion-item .accordion-title span svg path {
          fill: #374151 !important;
        }
        [data-theme="light"] .section-faqs .accordion-item .accordion-title.current span svg path {
        ...
        .section-faqs .accordion-item .accordion-title {
          padding: 18px 20px;
        }
        .section-faqs .accordion-item .accordion-title .text {
          color: rgba(255,255,255,0.88);
          font-size: 16px;
          line-height: 1.45;
          font-weight: 700;
        }
        .section-faqs .accordion-item .accordion-title span {
          top: 18px;
          right: 18px;
          opacity: 0.9;
        }
        .section-faqs .accordion-item .accordion-faqs-content {
          padding-top: 10px;
        }
        .section-faqs .accordion-item .accordion-faqs-content p {
      ...
      `}</style>
      <img loading="lazy" decoding="async" className="img-item item-circle-2" src="/images/item/item-circle-blur.webp" alt="1111.tn's web development project screenshot" />
              ...
              <div className="heading fw-6 wow fadeInUp" data-wow-delay="0.1s">
                <span className="fw-4 fst-italic font-playfair-display animationtext letters rotate-3">
                  <span className="cd-words-wrapper">
                    <span className="item-text is-visible"><i className="in">D</i><i className="in">e</i><i className="in">s</i><i className="in">&nbsp;</i><i className="in">q</i><i className="in">u</i><i className="in">e</i><i className="in">s</i><i className="in">t</i><i className="in">i</i><i className="in">o</i><i className="in">n</i><i className="in">s</i><i className="in">&nbsp;</i><i className="in">?</i></span>
                    <span className="item-text is-hidden"><i className="in">D</i><i className="in">e</i><i className="in">s</i><i className="in">&nbsp;</i><i className="in">q</i><i className="in">u</i><i className="in">e</i><i className="in">s</i><i className="in">t</i><i className="in">i</i><i className="in">o</i><i className="in">n</i><i className="in">s</i><i className="in">&nbsp;</i><i className="in">?</i></span>
                    <span className="item-text is-hidden"><i className="out">D</i><i className="out">e</i><i className="out">s</i><i className="out">&nbsp;</i><i className="out">q</i><i className="out">u</i><i className="out">e</i><i className="out">s</i><i className="out">t</i><i className="out">i</i><i className="out">o</i><i className="out">n</i><i className="out">s</i><i className="out">&nbsp;</i><i className="out">?</i></span>
                  </span>
                </span>
