...
const fallbackPredictionProducts = [
  ...
  },
  {
    ...
    href: "/products",
    chartPrices: [
      1399, 1380, 1350, 1320, 1290, 1270, 1260, 1255, 1249, 1249, 1260, 1310,
    ],
    chartMin: 1200,
    chartMax: 1450,
    stats: [
  ...
  },
  {
    ...
    href: "/products",
    chartPrices: [
      3299, 3200, 3100, 3050, 2980, 2950, 2930, 2910, 2899, 2899, 2950, 3050,
    ],
    chartMin: 2800,
    chartMax: 3400,
    stats: [
...
const PriceChart = ({
  ...
  const py = (v: number) =>
    padT + chartH - ((v - minP) / (maxP - minP)) * chartH;
  ...
  const areaPath =
    linePath +
    ` L${px(months.length - 1).toFixed(1)},${(padT + chartH).toFixed(1)} L${padL},${(padT + chartH).toFixed(1)} Z`;
      ...
      <defs>
        <linearGradient id="pred-area-grad" x1="0" y1="0" x2="0" y2="1">
          <stop
            offset="5%"
            stopColor={areaStart}
            stopOpacity={isLight ? 0.22 : 0.18}
          />
          <stop
            offset="95%"
            stopColor={areaEnd}
            stopOpacity={isLight ? 0.03 : 0.01}
          />
        </linearGradient>
...
export default function PredictionSection() {
  ...
  useEffect(() => {
    const t = setInterval(
      () => goTo((current + 1) % fallbackPredictionProducts.length),
      4000,
    );
    ...
    >
      ...
      <div className="container">
        ...
        <div
          ...
          className="pred-heading wow fadeInUp"
          data-wow-delay="0s"
        >
          <div
            style={{
          ...
          >
            Notre IA prédit les hausses de prix imminentes. Achetez maintenant
            avant que les prix augmentent.
          </p>
        </div>
        ...
        <div className="row g-4 align-items-stretch">
            ...
            >
              ...
              >
                {fallbackPredictionProducts.map((_, i) => (
                  <button
                    key={i}
                    className={`pred-dot ${i === current ? "is-active" : ""}`}
                    onClick={() => goTo(i)}
                    style={{
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <span style={{ color: "#fff" }}>{p.rating}</span> (
                        {p.reviews})
                      </span>
                    </div>
                  </div>
                ...
                >
                  ...
                  <a
                    href={p.href}
                    target="_blank"
                    className="pred-cta tf-btn-3 light_skew_hover"
                    style={{
                      display: "flex",
                      alignItems: "center",
                      justifyContent: "space-between",
          ...
          <div
            className="pred-right-col col-lg-7 wow fadeInUp"
            data-wow-delay="0.2s"
            style={{
              display: "flex",
              flexDirection: "column",
          ...
          >
            ...
            >
              ...
              <div>
                <div
                  className="pred-alert-title"
                  style={{ fontSize: "17px", fontWeight: 900, color: "#fff" }}
                >
                  Alerte de Prix
                </div>
                <div
                  className="pred-alert-copy"
                  style={{
                    fontSize: "13px",
                    fontWeight: 500,
                    color: "rgba(255,255,255,0.45)",
            ...
            >
              ...
              >
                <div
                  className="pred-chart-title"
                  style={{ fontSize: "14px", fontWeight: 800, color: "#fff" }}
                >
                  {p.chartTitle}
                </div>
                <div
                  className="pred-chart-legend"
              ...
              <div
                className="pred-chart-wrap"
                style={{ width: "100%", height: "360px" }}
              >
                <PriceChart
                  prices={p.chartPrices}
                  minP={p.chartMin}
                  maxP={p.chartMax}
                  isLight={isLight}
                />
              ...
              >
                {p.stats.map((s, i) => (
                  <div
                    key={i}
                    className={`pred-stat ${s.highlight ? "pred-stat-highlight" : ""}`}
                    style={{
                  ...
                  >
                    ...
                    <div
                      className={`pred-stat-value ${s.highlight ? "pred-stat-value-highlight" : ""}`}
                      style={{
                        fontSize: "15px",
                        fontWeight: 800,
                        color: s.highlight ? "#3BDEB9" : "#fff",
                      }}
                    >
                      {s.value}
                    </div>
