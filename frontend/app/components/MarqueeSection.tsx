  ...
  >
    <g clipPath="url(#marquee-clip)">
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M23.94 16.5L32.2515 21.2231L28.4072 27.7768L20.0957 23.0537V32.5H12.4072V23.0537L4.09569 27.7769L0.251465 21.2231L8.56296 16.5L0.251465 11.7768L4.09569 5.22312L12.4072 9.94631V0.5H20.0957V9.94631L28.4072 5.22319L32.2515 11.7769L23.94 16.5Z"
        fill="white"
      />
    </g>
    <defs>
      ...
      <div style={{ overflow: "hidden" }}>
        <div className="marquee-track tf-brand style-1">
          {repeated.map((text, index) => (
            <Fragment key={index}>
              <div
                className="brand-item text-uppercase"
                style={{ flex: "0 0 auto" }}
              >
                <div className="h1 fw-7 text-gradient style-4 animation-none">
                  {text}
                </div>
              </div>
