export default function MobileSection() {
  return (
    <section className="section-mobile">
      <img loading="lazy" className="item-1 item-circle-1" src="/images/item/item-circle.webp" alt="1111.tn mobile comparison preview" />
      <div className="container-2">
        <div className="row">
          <div className="col-12">
            <div className="heading-section center">
              <img loading="lazy" className="img-bg" src="/images/item/grid-2.webp" alt="1111.tn mobile comparison preview" />
              ...
              <div className="heading wow fadeInUp" data-wow-delay="0.1s">
                <div>
                  <img loading="lazy" src="/images/item/arrow.webp" alt="1111.tn's web development project screenshot" />
                </div>
                Expérience
              </div>
