...
import { ArrowRight, BadgeCheck, Database, LineChart, Lock, Sparkles } from "lucide-react"
        ...
        <article className={`dashboard-data-card ${accentClass}`}>
                ...
                <div className="dashboard-data-card-logoWrap">
                    <div className="dashboard-data-card-logo">
                        {shopLogo ? (
                            ...
                            <span className="dashboard-data-card-logoFallback">{initials}</span>
                        )}
                    </div>
                    <div>
            ...
            <div className="dashboard-data-card-metrics">
                <div className="dashboard-data-card-metric">
                    <span><Database className="size-4" /> Coverage</span>
                    <strong>{coverage}</strong>
                </div>
                <div className="dashboard-data-card-metric">
                    <span><LineChart className="size-4" /> Refresh</span>
            ...
            <div className="dashboard-data-card-footer">
                ...
                <Link href={`/dashboard/data-market/${slug}`} className="dashboard-data-card-cta">
