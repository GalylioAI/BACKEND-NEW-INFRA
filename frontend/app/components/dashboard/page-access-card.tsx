...
import { Eye, EyeOff, Globe, Users, UserCog, Shield, Save, Loader2 } from "lucide-react"
import { useAuth } from "@/contexts/AuthContext"
import { upsertAccessRule } from "@/lib/api/admin"
...
interface PageAccessCardProps {
    ...
    initialRole?: "client" | "admin" | "superadmin" | "both"
...
export function PageAccessCard({
    ...
    const [selectedRole, setSelectedRole] = useState<"client" | "admin" | "superadmin" | "both">(initialRole)
    ...
    const allowedRoles = useMemo(() => {
        if (selectedRole === "both") return ["client", "admin"] as const
    ...
    const handleRoleChange = (role: "client" | "admin" | "superadmin" | "both") => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            setSaveError(error instanceof Error ? error.message : "Unable to save access rule")
        } finally {
            setSaving(false)
        }
    }
