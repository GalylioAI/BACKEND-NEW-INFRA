      ...
      <main className="p-6">
        <section className="dashboard-data-market-hero">
          <div className="dashboard-data-market-copy">
            <span className="dashboard-data-market-kicker">
              B2B store intelligence
            </span>
            <h2>
              Turn tracked stores into revenue-ready datasets your clients
              actually want to buy.
            </h2>
            <p>
              Each pack includes structured pricing intelligence, availability
              monitoring, promo visibility, and category coverage. Position
              every retailer as a premium data asset, not just a source.
            </p>
          ...
          <aside className="dashboard-data-market-aside">
            <span className="dashboard-data-market-aside-label">
              Best for B2B sales
            </span>
            <strong>Full Data Access</strong>
            <p>
              Give buyers an immediate sense of exclusivity with logo-led cards,
              sharp value framing, and clear access messaging on every store.
            </p>
          </aside>
        </section>
