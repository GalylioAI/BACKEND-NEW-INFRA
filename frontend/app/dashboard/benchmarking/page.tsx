              ...
              <div className="max-w-3xl space-y-3">
                ...
                <div>
                  ...
                  <p className="mt-2 max-w-2xl text-sm leading-6 text-muted-foreground">
                    Le tableau ci-dessous compare les secteurs, les familles et
                    les signaux de marché dans un bloc séparé, pour éviter que
                    la navigation supérieure ne masque les visualisations.
                  </p>
                </div>
              </div>
